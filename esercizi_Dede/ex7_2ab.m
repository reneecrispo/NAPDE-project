...
% Based on GeoPDEs. Imposition of the Dirichlet boundary conditions by
% means of L2 projection or "interpolation at the control points".
%
%--------------------------------------------------------------------------
%
%   - \nabla \cdot (\mu \nabla u) = f,    in \Omega
...
g = @( x, y, ind )( sin( pi * y.^2 ) .* ( ind == 1 ) );    % Dirichlet data (for different boundaries)
% g = @( x, y, ind )( ( y > 2/3 ) .* ( ind == 1 ) );
