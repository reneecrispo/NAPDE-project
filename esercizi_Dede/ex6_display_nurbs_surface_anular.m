%--------------------------------------------------------------------------
% display NURBS surface in R^2, anular disk
%
% L. Dede'
% EPFL, 11 April 2013
%
...
xyz_p( 1 : 3, 2, 1 ) = [ 1+ttt/2; 0; 0 ]; 
ww( 2, 1 ) = 1 ;
xyz_p( 1 : 3, 2, 2 ) = [ 1+ttt/2; 1+ttt/2; 0 ]; 
ww( 2, 2 ) = sqrt( 2 ) / 2 ;
xyz_p( 1 : 3, 2, 3 ) = [ 0; 1+ttt/2; 0 ]; 
ww( 2, 3 ) = 1;

% third row in parametric direction 1 
xyz_p( 1 : 3, 3, 1 ) = [ 1+ttt; 0; 0 ]; 
ww( 3, 1 ) = 1 ;
xyz_p( 1 : 3, 3, 2 ) = [ 1+ttt; 1+ttt; 0 ]; 
ww( 3, 2 ) = sqrt( 2 ) / 2 ;
xyz_p( 1 : 3, 3, 3 ) = [ 0; 1+ttt; 0 ]; 
ww( 3, 3 ) = 1;
...
grid on
view(0,90)
axis([-0.05 1+ttt+0.05 -0.05 1+ttt+0.05])