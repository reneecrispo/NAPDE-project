...
ww( 1, 1, 1 ) = 1;
xyz_p( 1 : 3, 1, 1, 2 ) = [ 1; 0; 10 ]; 
ww( 1, 1, 2 ) = 1 ;

xyz_p( 1 : 3, 1, 2, 1 ) = [ 1; 1; 0 ]; 
ww( 1, 2, 1 ) = sqrt( 2 ) / 2;
xyz_p( 1 : 3, 1, 2, 2 ) = [ 1; 1; 10 ]; 
ww( 1, 2, 2 ) = sqrt( 2 ) / 2;

xyz_p( 1 : 3, 1, 3, 1 ) = [ 0; 1; 0 ]; 
ww( 1, 3, 1 ) = 1;
xyz_p( 1 : 3, 1, 3, 2 ) = [ 0; 1; 10 ]; 
ww( 1, 3, 2 ) = 1;

xyz_p( 1 : 3, 1, 4, 1 ) = [ -1; 1; 0 ]; 
ww( 1, 4, 1 ) = sqrt( 2 ) / 2;
xyz_p( 1 : 3, 1, 4, 2 ) = [ -1; 1; 10 ]; 
ww( 1, 4, 2 ) = sqrt( 2 ) / 2;

xyz_p( 1 : 3, 1, 5, 1 ) = [ -1; 0; 0 ]; 
ww( 1, 5, 1 ) = 1;
xyz_p( 1 : 3, 1, 5, 2 ) = [ -1; 0; 10 ]; 
ww( 1, 5, 2 ) = 1;

xyz_p( 1 : 3, 1, 6, 1 ) = [ -1; -1; 0 ]; 
ww( 1, 6, 1 ) = sqrt( 2 ) / 2;
xyz_p( 1 : 3, 1, 6, 2 ) = [ -1; -1; 10 ]; 
ww( 1, 6, 2 ) = sqrt( 2 ) / 2;

xyz_p( 1 : 3, 1, 7, 1 ) = [ 0; -1; 0 ]; 
ww( 1, 7, 1 ) = 1;
xyz_p( 1 : 3, 1, 7, 2 ) = [ 0; -1; 10 ]; 
ww( 1, 7, 2 ) = 1;

xyz_p( 1 : 3, 1, 8, 1 ) = [ 1; -1; 0 ]; 
ww( 1, 8, 1 ) = sqrt( 2 ) / 2;
xyz_p( 1 : 3, 1, 8, 2 ) = [ 1; -1; 10 ]; 
ww( 1, 8, 2 ) = sqrt( 2 ) / 2;

xyz_p( 1 : 3, 1, 9, 1 ) = [ 1; 0; 0 ]; 
ww( 1, 9, 1 ) = 1;
xyz_p( 1 : 3, 1, 9, 2 ) = [ 1; 0; 10 ]; 
ww( 1, 9, 2 ) = 1;

% fix x 2, along y
xyz_p( 1 : 3, 2, 1, 1 ) = [ 1.5; 0; 0 ]; 
ww( 2, 1, 1 ) = 1;
xyz_p( 1 : 3, 2, 1, 2 ) = [ 1.5; 0; 10 ]; 
ww( 2, 1, 2 ) = 1;

xyz_p( 1 : 3, 2, 2, 1 ) = [ 1.5; 1.5; 0 ]; 
ww( 2, 2, 1 ) = sqrt( 2 ) / 2;
xyz_p( 1 : 3, 2, 2, 2 ) = [ 1.5; 1.5; 10 ]; 
ww( 2, 2, 2 ) = sqrt( 2 ) / 2;

xyz_p( 1 : 3, 2, 3, 1 ) = [ 0; 1.5; 0 ]; 
ww( 2, 3, 1 ) = 1;
xyz_p( 1 : 3, 2, 3, 2 ) = [ 0; 1.5; 10 ]; 
ww( 2, 3, 2 ) = 1;

xyz_p( 1 : 3, 2, 4, 1 ) = [ -1.5; 1.5; 0 ]; 
ww( 2, 4, 1 ) = sqrt( 2 ) / 2;
xyz_p( 1 : 3, 2, 4, 2 ) = [ -1.5; 1.5; 10 ]; 
ww( 2, 4, 2 ) = sqrt( 2 ) / 2;

xyz_p( 1 : 3, 2, 5, 1 ) = [ -1.5; 0; 0 ]; 
ww( 2, 5, 1 ) = 1;
xyz_p( 1 : 3, 2, 5, 2 ) = [ -1.5; 0; 10 ]; 
ww( 2, 5, 2 ) = 1;

xyz_p( 1 : 3, 2, 6, 1 ) = [ -1.5; -1.5; 0 ]; 
ww( 2, 6, 1 ) = sqrt( 2 ) / 2;
xyz_p( 1 : 3, 2, 6, 2 ) = [ -1.5; -1.5; 10 ]; 
ww( 2, 6, 2 ) = sqrt( 2 ) / 2;

xyz_p( 1 : 3, 2, 7, 1 ) = [ 0; -1.5; 0 ]; 
ww( 2, 7, 1 ) = 1;
xyz_p( 1 : 3, 2, 7, 2 ) = [ 0; -1.5; 10 ]; 
ww( 2, 7, 2 ) = 1;

xyz_p( 1 : 3, 2, 8, 1 ) = [ 1.5; -1.5; 0 ]; 
ww( 2, 8, 1 ) = sqrt( 2 ) / 2;
xyz_p( 1 : 3, 2, 8, 2 ) = [ 1.5; -1.5; 10 ]; 
ww( 2, 8, 2 ) = sqrt( 2 ) / 2;

xyz_p( 1 : 3, 2, 9, 1 ) = [ 1.5; 0; 0 ]; 
ww( 2, 9, 1 ) = 1;
xyz_p( 1 : 3, 2, 9, 2 ) = [ 1.5; 0; 10 ]; 
ww( 2, 9, 2 ) = 1;
...
grid on
box on
axis([-1.55 1.55 -1.55 1.55 -0.05 10.05])
