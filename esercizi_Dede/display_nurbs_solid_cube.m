%--------------------------------------------------------------------------
% display NURBS solid in R^3, cube
%
% L. Dede'
% EPFL, 11 April 2013
%
...
xyz_p( 1 : 3, 1, 1, 1 ) = [ 0; 0; 0 ]; 
ww( 1, 1, 1 ) = 1;
xyz_p( 1 : 3, 1, 1, 2 ) = [ 0; 0; 1 ]; 
ww( 1, 1, 2 ) = 1 ;

xyz_p( 1 : 3, 1, 2, 1 ) = [ 0; 1; 0 ]; 
ww( 1, 2, 1 ) = 1;
xyz_p( 1 : 3, 1, 2, 2 ) = [ 0; 1; 1 ]; 
ww( 1, 2, 2 ) = 1;

xyz_p( 1 : 3, 2, 1, 1 ) = [ 1; 0; 0 ]; 
ww( 2, 1, 1 ) = 1;
xyz_p( 1 : 3, 2, 1, 2 ) = [ 1; 0; 1 ]; 
ww( 2, 1, 2 ) = 1;

xyz_p( 1 : 3, 2, 2, 1 ) = [ 1; 1; 0 ]; 
ww( 2, 2, 1 ) = 1;
xyz_p( 1 : 3, 2, 2, 2 ) = [ 1; 1; 1 ]; 
ww( 2, 2, 2 ) = 1;
